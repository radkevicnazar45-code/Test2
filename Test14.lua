...
local CFG = {
	...
	AnimeBackgroundImage = "rbxassetid://72824076576061",
...
panel.Size = UDim2.fromOffset(330,350)
...
fovLabel.Position = UDim2.fromOffset(12,174)
...
visualInfo.Position = UDim2.fromOffset(12,216)
...
status.Position = UDim2.fromOffset(12,240)
...
mode.Position = UDim2.fromOffset(12,264)
...
print("[TrainingCombatHUD V15] Loaded - PLAYER AIM/ESP ONLY")
